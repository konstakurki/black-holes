...
\begin{eqna}
\dd\tau^2=\sum_{\alpha=0}^3\sum_{\beta=0}^3\,g_{\alpha\beta}\,\dd x^\alpha\dd x^\beta\doteq g_{\alpha\beta}\,\dd x^\alpha\dd x^\beta,
\end{eqna}
...
\begin{eqna}
\dd\tau^2=g_{\alpha\beta}\,\pder{x^\alpha}{\tilde{x}^\gamma}\dd\tilde{x}^\gamma\,\pder{x^\beta}{\tilde{x}^\delta}\dd\tilde{x}^\delta=\tilde{g}_{\alpha\beta}\,\dd \tilde{x}^\alpha\dd \tilde{x}^\beta,
\end{eqna}
in which
\begin{eqna}
\tilde{g}_{\alpha\beta}=\pder{x^\gamma}{\tilde{x}^\alpha}\,\pder{x^\delta}{\tilde{x}^\beta}\,g_{\gamma\delta}.
\end{eqna}
...
This is a number called Ricci scalar.
 ...
 %We can also form other scalars out of the Riemann tensor, for example \(R^\alpha_{\phantom{\alpha}\beta\gamma\mu}R^\beta_{\phantom{\beta}\alpha\delta\nu}g^{\gamma\delta}g^{\mu\nu}\), but the Ricci scalar is (have to figure out why) the one we should use for the spacetime action.
