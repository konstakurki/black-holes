...
\begin{eqna}
S=\int_{\mathcal{V}}(R+\mathcal{L})\sqrt{|g|}\,\dd^4x=\int_{\mathcal{V}}\left(\sqrt{|g|}R+\sqrt{|g|}\mathcal{L}\right)\,\dd^4x.
\end{eqna}
...
\delta S&=&\int_{\mathcal{V}}\delta\left(\sqrt{|g|}R+\sqrt{|g|}\mathcal{L}\right)\,\dd^4x\\
        &=&\int_{\mathcal{V}}\left(\frac{\delta\sqrt{|g|}R}{\delta g^{\coa\cob}}+\frac{\delta\sqrt{|g|}\mathcal{L}}{\delta g^{\coa\cob}}\right)\delta g^{\coa\cob}\,\dd^4x\\
        &=&\int_{\mathcal{V}}\left(\sqrt{|g|}\frac{\delta R}{\delta g^{\coa\cob}}+\frac{\delta\sqrt{|g|}}{\delta g^{\coa\cob}}R+\frac{\delta\sqrt{|g|}\mathcal{L}}{\delta g^{\coa\cob}}\right)\delta g^{\coa\cob}\,\dd^4x\\
